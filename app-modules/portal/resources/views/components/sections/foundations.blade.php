    ...
    <div class="hp-container relative z-10 grid grid-cols-1 items-start gap-x-12 lg:grid-cols-[1fr_5fr]">
        ...
        <div class="flex flex-col gap-8">
            <x-he4rt::headline>
                ...
                <x-slot:description>
                    A 3 Pontos conecta empresas e startups inovadoras a talentos excepcionais, acelerando soluções reais
                    e transformando ideias em impacto.
                </x-slot>
                <x-slot:actions>
        ...
        <div
            ...
            class="grid grid-cols-1 gap-8 lg:col-start-2"
        >
            <x-he4rt::card class="gap-4">
                ...
                <x-slot:description class="text-xs leading-[1.5]">
                    Sua empresa tem uma visão clara, mas enfrenta desafios tecnológicos. Aqui na 3 Pontos, desenvolvemos
                    e implementamos soluções de ponta que transformam essas barreiras em oportunidades. Do
                    desenvolvimento customizado ao marketing digital estratégico, nós somos o parceiro que sua empresa
                    precisa para escalar com confiança.
                </x-slot>
            </x-he4rt::card>
