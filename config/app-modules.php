...
return [
    ...
    */
    ...
    'stubs' => [
        ...
        'src/Providers/StubClassNamePrefixServiceProvider.php' => base_path('stubs/app-modules/ServiceProvider.php'),
        'tests/Unit/ExampleTest.php' => base_path('stubs/app-modules/ExampleTest.php'),
        'tests/Feature/ExampleTest.php' => base_path('stubs/app-modules/.gitkeep'),
